...
public class MainActivity extends Activity {
    ...
    @Override public void onConfigurationChanged(Configuration newConfig){super.onConfigurationChanged(newConfig);if(running)renderFocus(remaining);else if(breaking)renderBreak(remaining);immersive();}
